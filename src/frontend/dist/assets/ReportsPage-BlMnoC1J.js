import { c as createLucideIcon, a7 as clsx, a8 as React, a9 as getDefaultExportFromCjs, r as reactExports, j as jsxRuntimeExports, f as formatCurrency, a2 as Receipt, T as Truck, g as formatDate, e as Skeleton, B as Button, C as ChartColumn, N as cn } from "./index-D0FyCSZw.js";
...
import { f as filterProps, _ as _baseExtremum, d as _baseGt, e as _baseIteratee, g as _baseLt, i as isFunction, h as Text, p as polarToCartesian, L as Layer, j as getTickClassName, k as adaptEventsOfChild, l as Label, D as Dot, m as Curve, n as isNil, o as getValueByDataKey, S as Shape, q as Animate, r as get, s as interpolateNumber, t as isEqual, v as isNumber, w as LabelList, x as uniqueId, G as Global, y as mathSign, z as findAllByType, B as Cell, E as getMaxRadius, F as getPercentValue, H as warn, I as generateCategoricalChart, J as Bar, X as XAxis, Y as YAxis, K as formatAxisMap, M as formatAxisMap$1, u as useSalesSummary, T as TrendingUp, R as ResponsiveContainer, A as AreaChart, a as CartesianGrid, b as Tooltip, c as Area, N as usePurchaseSummary, C as Clock, O as Legend, P as useGstBreakdown } from "./AreaChart-jd49KWGr.js";
...
function currentMonthRange() {
  ...
  return {
    fromTime: BigInt(start.getTime()) * BigInt(1e6),
    toTime: BigInt(now.getTime()) * BigInt(1e6)
  };
}
...
function MetricCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: cn("shadow-card", className), children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-medium uppercase tracking-wider mb-1 truncate", children: title }),
    ...
    Icon && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: cn(
          ...
          highlight ? "bg-accent/15 text-accent" : "bg-muted text-muted-foreground"
        ),
...
function DateRangePicker({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "w-4 h-4 text-muted-foreground flex-shrink-0" }),
...
function SkeletonCards({ count }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `grid grid-cols-2 lg:grid-cols-${count} gap-4`, children: keys.map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-24 rounded-xl" }, k)) });
}
function SalesTab({ range }) {
  ...
  const dailyData = reactExports.useMemo(() => {
    if (!sales) return [];
    const fromMs = Number(range.fromTime) / 1e6;
    const toMs = Number(range.toTime) / 1e6;
    const days = Math.max(
      1,
      Math.ceil((toMs - fromMs) / (1e3 * 60 * 60 * 24))
    );
    const dailyAvg = rupeesFromPaise(sales.totalSales) / days;
    return Array.from({ length: Math.min(days, 30) }, (_, i) => {
      const d = new Date(fromMs + i * 864e5);
  ...
  const topMedicines = reactExports.useMemo(() => {
  ...
  if (isLoading) return /* @__PURE__ */ jsxRuntimeExports.jsx(SkeletonCards, { count: 4 });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        MetricCard,
        {
          ...
          sub: `${(sales == null ? void 0 : sales.totalInvoices) ?? 0} invoices`,
          icon: TrendingUp,
          highlight: true,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        MetricCard,
        {
          ...
          value: (sales == null ? void 0 : sales.totalInvoices.toString()) ?? "0",
          sub: "billing cycles",
          icon: FileText
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          title: "GST Collected",
          value: formatCurrency((sales == null ? void 0 : sales.totalGst) ?? BigInt(0)),
          sub: "tax liability",
          icon: Receipt
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          title: "Net Returns",
          value: formatCurrency((sales == null ? void 0 : sales.totalReturns) ?? BigInt(0)),
          sub: "refunds issued",
          icon: RefreshCw
        }
      )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 pt-4 px-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold", children: "Revenue by Day" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "px-2 pb-4", children: dailyData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "flex items-center justify-center h-64 text-muted-foreground text-sm",
          "data-ocid": "reports.sales.chart_empty",
          children: "No revenue data for selected period"
        }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 pt-4 px-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold", children: "Payment Mode Breakdown" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "px-5 pb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: paymentData.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between mb-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-foreground", children: p.mode }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 pt-4 px-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold", children: "Top 5 Medicines Sold" }) }),
...
function PurchaseTab({ range }) {
  const { data: purchase, isLoading: purchaseLoading } = usePurchaseSummary(range);
  ...
  const recentOrders = reactExports.useMemo(() => {
    if (!orders) return [];
    return [...orders].sort((a, b) => Number(b.createdAt - a.createdAt)).slice(0, 10);
  }, [orders]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        MetricCard,
        {
          ...
          value: (purchase == null ? void 0 : purchase.totalOrders.toString()) ?? "0",
          sub: "all time",
          icon: Package,
          highlight: true
        }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          title: "Total Spend",
          value: formatCurrency((purchase == null ? void 0 : purchase.totalSpend) ?? BigInt(0)),
          sub: "on purchases",
          icon: TrendingUp
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        MetricCard,
        {
          ...
          value: (purchase == null ? void 0 : purchase.pendingOrders.toString()) ?? "0",
          sub: "awaiting action",
          icon: Clock
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          title: "Delivered",
          value: (purchase == null ? void 0 : purchase.deliveredOrders.toString()) ?? "0",
          sub: "completed",
          icon: CircleCheck
        }
      )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 pt-4 px-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold", children: "Order Status Breakdown" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pb-4", children: statusBreakdown.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "flex items-center justify-center h-48 text-muted-foreground text-sm",
            "data-ocid": "reports.purchase.pie_empty",
            children: "No orders in selected period"
          }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Pie,
            {
              ...
              labelLine: false,
              children: statusBreakdown.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Cell,
                {
                  fill: PO_STATUS_COLORS[entry.status] ?? "oklch(0.6 0.12 230)"
                },
                entry.status
              ))
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Legend,
            {
              iconType: "circle",
              iconSize: 8,
              formatter: (value) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "12px" }, children: value })
            }
          )
        ] }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 pt-4 px-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold", children: "Order Status Summary" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "px-5 pb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [
          { label: "Pending", key: "pending", icon: Clock },
          { label: "Confirmed", key: "confirmed", icon: CircleCheck },
          { label: "Shipped", key: "shipped", icon: Truck },
          { label: "Delivered", key: "delivered", icon: CircleCheck },
          { label: "Cancelled", key: "cancelled", icon: CircleX }
        ].map(({ label, key, icon: Icon }) => {
          const entry = statusBreakdown.find((s) => s.status === key);
          const count = (entry == null ? void 0 : entry.value) ?? 0;
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      style: {
                        background: PO_STATUS_COLORS[key] ?? "oklch(0.6 0.12 230)"
                      }
                    }
                  ),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-mono font-medium text-foreground", children: count }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 pt-4 px-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold", children: "Recent Purchase Orders" }) }),
        ...
        "table",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border bg-muted/40", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left text-xs font-semibold text-muted-foreground uppercase tracking-wider px-5 py-3", children: "Order #" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left text-xs font-semibold text-muted-foreground uppercase tracking-wider px-4 py-3", children: "Distributor" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right text-xs font-semibold text-muted-foreground uppercase tracking-wider px-4 py-3", children: "Amount" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center text-xs font-semibold text-muted-foreground uppercase tracking-wider px-4 py-3", children: "Status" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right text-xs font-semibold text-muted-foreground uppercase tracking-wider px-5 py-3", children: "Date" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: recentOrders.map((order, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "tr",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-mono text-foreground", children: [
                    "PO-",
                    order.id.toString().padStart(4, "0")
                  ] }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-foreground truncate block max-w-[180px]", children: order.distributorName }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium font-mono text-foreground", children: formatCurrency(order.totalAmount) }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { status: order.status }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: formatDate(order.createdAt) }) })
                ]
              },
              order.id.toString()
            )) })
...
function GstTab({ range }) {
  ...
  const gstRows = reactExports.useMemo(() => {
    if (!gst) return [];
    return gst.map((g) => ({
      rate: g.rate,
  ...
  const totalGst = reactExports.useMemo(() => {
    return gstRows.reduce((sum, r) => sum + r.gstAmount, BigInt(0));
  }, [gstRows]);
  const totalTaxable = reactExports.useMemo(() => {
  ...
  if (isLoading) return /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-64 rounded-xl" });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "shadow-card flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5 w-full", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-medium uppercase tracking-wider mb-2", children: "Export" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 pt-4 px-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold", children: "GST Rate Breakdown" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: gstRows.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "flex flex-col items-center justify-center py-14 text-muted-foreground",
            "data-ocid": "reports.gst.table_empty",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { className: "w-8 h-8 mb-2 opacity-50" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "No GST data for this period" })
            ]
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full", "data-ocid": "reports.gst.breakdown_table", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border bg-muted/40", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left text-xs font-semibold text-muted-foreground uppercase tracking-wider px-5 py-3", children: "GST Rate" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right text-xs font-semibold text-muted-foreground uppercase tracking-wider px-4 py-3", children: "Taxable Amt" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right text-xs font-semibold text-muted-foreground uppercase tracking-wider px-5 py-3", children: "GST Amt" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
            gstRows.map((row, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "tr",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        style: {
                          background: GST_PIE_COLORS[idx % GST_PIE_COLORS.length]
                        }
                      }
                    ),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-mono text-foreground", children: formatCurrency(row.taxableAmount) }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-mono font-medium text-accent", children: formatCurrency(row.gstAmount) }) })
                ]
              },
              row.rate
            )),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-muted/30", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold text-foreground", children: "Total" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold font-mono text-foreground", children: formatCurrency(totalTaxable) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold font-mono text-accent", children: formatCurrency(totalGst) }) })
            ] })
          ] })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 pt-4 px-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold", children: "GST Distribution" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pb-4", children: pieData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-52 text-muted-foreground text-sm", children: "No data available" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 240, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Pie,
            {
              data: pieData,
...
function ReportsPage() {
  const [tab, setTab] = reactExports.useState("sales");
  const defaultRange = currentMonthRange();
  const [fromDate, setFromDate] = reactExports.useState(
    timestampToDate(defaultRange.fromTime)
  );
  const [toDate, setToDate] = reactExports.useState(timestampToDate(defaultRange.toTime));
  const range = reactExports.useMemo(() => {
    const from = dateToTimestamp(fromDate);
    const toMs = BigInt(new Date(toDate).setHours(23, 59, 59, 999)) * BigInt(1e6);
    return { fromTime: from, toTime: toMs };
  }, [fromDate, toDate]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "reports.page", className: "flex flex-col h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PageHeader,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto p-6 space-y-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { value: tab, onValueChange: setTab, "data-ocid": "reports.tabs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "sales", "data-ocid": "reports.sales_tab", children: "Sales" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "purchase", "data-ocid": "reports.purchase_tab", children: "Purchase" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "gst", "data-ocid": "reports.gst_tab", children: "GST" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "sales", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SalesTab, { range }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "purchase", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PurchaseTab, { range }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "gst", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GstTab, { range }) })
    ] }) })
  ] });
}
export {
